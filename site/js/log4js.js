...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['exports'], function(exports) {
      ...
      root.Log4js = factory(root, exports);
    });
    ...
    root.Log4js = factory(root, {});
  }

}(this, function(root, Log4js) {
...
/*	$import: function (src) {
  ...
  Log4js.JSONLayout.prototype = Log4js.extend(new Log4js.Layout(), {
    ...
    format: function(loggingEvent) {
		...
		timestamp: loggingEvent.startTime
	      ...
	      if(loggingEvent.exception) {
		event.exception = loggingEvent.exception
	      }
	      return JSON.stringify({ LoggingEvent: event })
	    },
      /** 
       * Returns the content type output by this layout. 
       * @return The base class returns "text/xml".
  ...
  log4jsLogger.setLevel(Log4js.Level.ERROR);
